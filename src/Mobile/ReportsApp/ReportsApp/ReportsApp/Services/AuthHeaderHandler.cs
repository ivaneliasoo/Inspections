...
namespace ReportsApp.Services
{
    public class AuthHeaderHandler : DelegatingHandler
    {
        ...
        public AuthHeaderHandler(IAuthorizationStore authorizationStore, HttpClientHandler innerHandler = null)
            : base(innerHandler ?? new HttpClientHandler() { ServerCertificateCustomValidationCallback = (a, b, c, d) => { return true; } }) => _authorizationStore = authorizationStore ?? throw new ArgumentNullException(nameof(authorizationStore));
