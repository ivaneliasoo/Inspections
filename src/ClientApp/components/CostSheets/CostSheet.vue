  ...
  <div id="costsheet-container">
    <v-container class="my-n8 py-n8 ml-n4 pl-n4 mr-2 pr-2 fill-height">
      ...
      <v-row>
        ...
        <v-col
          v-if="!costSheet.isTemplate"
          class="mt-n2 pt-n2 mb-n5 pb-n5 text-left text-body"
          cols="1"
        >
          Location:
        </v-col>
              ...
              >
                ...
                <tbody class="cs-section">
                  <tr>
                    ...
                    <td class="title-3" />
                    <td class="title-3" />
                    <td class="title-3">Material Cost</td>
                    <td class="title-3">
                      <NumberField
                    ...
                    <td colspan="2" class="text-right title-3">Labour Cost</td>
                    <td class="title-3">
                      <NumberField
                    ...
                    <td colspan="3" class="text-right title-3">Total Quote</td>
                ...
                <tbody class="cs-section">
                  <td colspan="10" class="text-h5 text-left">&nbsp;</td>
                </tbody>
                ...
                <tbody class="cs-section">
                  ...
                  <tr>
                    ...
                    <td
                      class="text-caption font-weight-bold title-7 cs-section"
                      style="background-color: #d1eee1"
                    >
                      <NumberField
                        v-model="costSheet.materialMarkup"
                        format="percent"
                  ...
                  <tr>
                    <td colspan="13" class="text-caption title-7">&nbsp;</td>
                  </tr>
                      ...
                      <table>
                        <tbody>
                          <tr>
                            <td
                              colspan="3"
                              class="text-body-2 text-left title-7"
                            >
          ...
          if (fld === document.activeElement) {
            if (key === Key.down) {
              ...
              if (i > 0) {
                ...
                const fld =
                  this.$refs.finalOverallMarkup.$el.querySelector('input')
                fld.focus()
              }
