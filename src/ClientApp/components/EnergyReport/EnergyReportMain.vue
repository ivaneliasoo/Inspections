<template>
  <v-container>
                ...
                <tr>
                  <td class="search-box" style="width: 100%">
                    <EnergyReportSearch
                      :data="reports"
                      :templates="templates"
                      :field-names="['name', 'location', 'template', 'circuit', 'dateCreated']"
                      place-holder="Search"
                      :size="52"
            ...
            <v-tab-item>
              <v-container>
                ...
                >
                  <thead>
                    <tr class="my-0 py-0">
                      <th class="text-left" style="width:10%; border: 2px solid lightgray;" />
                      <th class="text-left" style="width:10%; border: 2px solid lightgray;">
                        % Time
                      </th>
                      <th class="text-left" style="width:10%; border: 2px solid lightgray;">
                ...
                <v-row justify="start">
                  <v-col cols="10">
                    ...
                    >
                      <thead>
                        <tr>
                          <th class="text-left" style="width:26%; border: 1px solid lightgray;">
                            Parameter
                          </th>
                          <th class="text-left" style="width:29%; border: 1px solid lightgray;">
                            Column
                          </th>
                          <th class="text-left" style="width:8%; border: 1px solid lightgray;">
                            Peaks
                          </th>
                          <th class="text-left" style="width:20%; border: 1px solid lightgray;">
                            Color
                          </th>
          ...
          <v-form>
            ...
            >
              <thead class="my-0 py-0">
                <tr class="my-0 py-0">
                  <th class="text-left" style="width: 10%; border: 1px solid lightgray;">
                    Num.
                  </th>
                  <th class="text-left" style="width: 45%; border: 1px solid lightgray;">
                    Title
                  </th>
                  <th class="text-left" style="width: 45%; border: 1px solid lightgray;">
                    Remarks
    ...
    <v-dialog v-model="reportDialog.showReportInfo" class="report-dialog" max-width="900px">
      <v-card>
        <v-card-title>
    ...
    <v-dialog v-model="reportDialog.showReportCover" class="report-dialog" max-width="900px">
      <v-card>
        <v-card-title>
