            ...
            if (page == 1) {
                return [
                    ...
                    },
                    {
                        svg:
                        `<svg>
                            <rect x="45" y="65" width="380" height="680" 
                                style="fill: #F5DEB3; stroke: black; stroke-width: 2px;"/>
                                <line x1="60" y1="190" x2="170" y2="190" style="stroke:#000000;stroke-width:3px;"/>
                        </svg>`
                    }
                ];
