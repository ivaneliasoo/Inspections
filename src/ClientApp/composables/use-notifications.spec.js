...
describe('Notifications parser test', () => {
  it('devuelve notFoundMessage y el tipo info cuando el error es 404', () => {
    ...
    const error = { response: { status: 404, data: { title: 'error error', detail: 'detail message' } } }
    const result = notificationErrorParser('Mensaje por Defecto', 'Mensaje cuando devuelve 404', error)
