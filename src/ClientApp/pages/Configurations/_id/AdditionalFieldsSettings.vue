<template>
  <div>
    <h3>Reports Configuration .- Additional Fields Configuration</h3>
    <h6>Lets configurate some additional fields</h6>
...
export default defineComponent({
  ...
  setup () {
    ...
    useFetch(async () => {
      ...
      if (
        result.additionalFileds &&
        result.additionalFileds.fieldsDefinitions
      ) {
        values.value = result.additionalFileds.fieldsDefinitions
      } else {
        values.value = []
      }
    })
