<template>
  <div style="display: block">
    ...
    <div class="wrapper">
      <div class="row">
        <div class="cell">
          REPORT BY LICENSED ELECTRICAL WORKER (LEW) FOR
          CONDOMINIUMS AND MULTI-TENANTED BUILDINGS
        </div>
      </div>
      <div class="row">
        <div class="description">
          This form has 7 sections and shall be filled up during site inspection in the presence of the consumer’s representative.
          It may take at least 40 minutes to fill up the form, depending on the scale of the consumer’s electrical installation.
          You will require your licence number and the particulars of the electrical installation licence to complete this report.
        </div>
      </div>
      <div class="row">
        <div class="note">
          ...
          The original copy of this report shall be submitted to the Energy Market Authority of Singapore,
          in accordance with the conditions of the installation licence issued to the premises
        </div>
      </div>
      <div class="row">
        <div class="instructions">
          <span>All</span>
          boxes must be filled.  Tick (), (X) or (NA) as appropriate to denote acceptable, unacceptable and not applicable conditions respectively.
          The “Remarks” column is provided for additional details including rectification action for unacceptable conditions.
        </div>
      </div>
      <div class="row">
      ...
      <PrintingReportsCheckLists
        v-if="reportData.checkLists && configuration.checkListMetadata && configuration.checkListMetadata.display === 0"
        :check-lists="reportData.checkLists"
      />
      <div v-if="reportData.checkLists && configuration.checkListMetadata && configuration.checkListMetadata.display === 1">
      ...
      <div class="row">
        <table class="my_table">
          ...
          <tr>
            <td>
              I have carried out inspection on <input v-model="formatedDate" type="text"> (date of inspection), witnessed by the representative of the licensee and hereby
              I declare that the electrical installation is fit and safe for operation.
            </td>
          </tr>
        </table>
      </div>
      <div v-if="reportData.signatures" class="row">
        <div class="particulars">
          <div class="particular-inputs">
            ...
            <input v-model="reportData.signatures[0].responsibleName" class="special-input" type="text">
            <label for="">
              Licence No:
            </label>
            <input v-model="reportData.licenseNumber" class="special-input" type="text">
      ...
      <div v-if="reportData.signatures" class="row">
        <div class="particulars">
          ...
          <div class="particular-inputs">
            ...
            <input v-model="reportData.signatures[1].responsibleName" type="text">
          </div>
          <div class="particular-inputs">
            <label for="">
              Designation:
